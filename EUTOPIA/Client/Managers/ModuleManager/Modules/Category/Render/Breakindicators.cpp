...
BreakIndicators::BreakIndicators()
    : Module("BreakIndicators", "Renders the progress of a block being broken", Category::RENDER) {
    registerSetting(new ColorSetting("StartColor", "The color for the non-broken block",
                                     &startColor, UIColor(255, 0, 0), false));
    registerSetting(new ColorSetting("EndColor", "The color for the non-broken block", &endColor,
